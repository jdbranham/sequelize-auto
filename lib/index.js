...
module.exports = (function(){
  ...
  AutoSequelize.prototype.run = function(options, callback) {
    ...
    this.sequelize.query(this.queryInterface.QueryGenerator.showTablesQuery(), {raw: true})
    .then(function(tables){
      var _tables = {};
      async.each(tables[0], function(table, _callback){
        var tableName = Array.isArray(table) ? table[0]['TABLE_NAME'] : table['TABLE_NAME'];
        ...
        async.each(tableNames, function(table, _callback){
          ...
          text[table] = "'use strict'; \n\n/* jshint indent: " + options.indentation + " */\n\n";
